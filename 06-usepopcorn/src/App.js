...
function MovieDetails({ selectedId, onCloseDetail, onAddWatched, watched }) {
  ...
  const isWatched = watched
    .map((el) => {
      // console.log(typeof selectedId, typeof el.imdbID);
      return el.imdbId;
    })
    .includes(selectedId);
  ...
  function handleAdd() {
    const newWatchedMovie = {
      ...
      chooseRatingAmount: countRef.current,
    };
    onAddWatched(newWatchedMovie);
    onCloseDetail();
  }

  useKey("Escape", onCloseDetail);
  // useEffect(
  //   function () {
  //     function callback(e) {
  //       if (e.code === "Escape") onCloseDetail();
  //     }
  //     document.addEventListener("keydown", callback);
