  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center border-2 border-blue-300 relative">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute border border-red-500 right-0.5 z-50 top-[3px]  md:right-0.5 md:top-[5px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
